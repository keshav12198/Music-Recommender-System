...
var xhrList = []; //cross-html-request
                            ...
                            if(!$("#"+recomId)[0]&&deletedArray.indexOf(recomId)<0) {
                                ...
                                var deletedItem = $("div#"+deletedRecomId),
                                    ...
                                    newItem = '<div class="recom-items lift-top ' + seedType1
                                        ...
                                        '</iframe><div class="recom-icon"><div class="recom-deletion"><i class="fa fa-times" aria-hidden="true">' +
...
$.ajax({
        ...
        success: function (data) {
            ...
            var selected_seed_artist = data.seed.artist.slice(0, 50)
            ...
            var regDropArtist = function () {
                ...
                xhr = $.ajax({
                    ...
                    beforeSend: function () {
                        ...
                        $("div#recom-seeds, div.drop-block").hide();
                        $("div.loading").show();
                    },
                    ...
                    complete: function () {
                        ...
                        if(!isInitialized){
                            $("div#recom-seeds, div.drop-block").show();
                            $("div.loading").hide();
                        }
                    }
            ...
            var selected_seed_track = data.seed.track.slice(0, 50)
            ...
            var selected_seed_genre = data.seed.genre.slice(0, 50)
            var dragged_genre;
                            ...
                            .then(function () {
                                ...
                                Promise
                                    ...
                                    .then(function () {
                                        ...
                                        $("div#recom-seeds, div.drop-block, div#seed-block").show();
                                        getRecomBySeed("recom-seeds");
                                        xhrList=[]
                                        isInitialized = false;
